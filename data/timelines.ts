...
export const timelines: TimelineItem[] = [
  {
    id: 1,
    year: '2025 - present',
    role: 'Algorithmic Trader & Expert Advisor Developer',
    company: 'Self-Employed',
    desc: 'Building and refining automated trading systems and MetaTrader Expert Advisors. Focus on strategy research, backtesting, risk management, and deploying algorithmic tools for live market execution.',
  },
  {
    id: 2,
    year: '2023 - present',
